  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full rounded-[24px] p-[2px] relative group"
        style={{
      ...
      >
        ...
        <motion.div
          className="absolute -inset-1 rounded-[26px] opacity-0 group-hover:opacity-100 blur-md transition-opacity duration-500"
          style={{
            background: "linear-gradient(135deg, #915eff 0%, #00cea8 50%, #bf61ff 100%)"
          }}
        />
        ...
        <div
          className="relative bg-gradient-to-br from-[#1d1836] to-[#151030] rounded-[22px] py-8 px-10 min-h-[300px] flex justify-evenly items-center flex-col backdrop-blur-sm"
        >
          {/* Decorative elements */}
          <div className="absolute top-4 right-4 w-20 h-20 rounded-full bg-gradient-to-br from-[#915eff]/10 to-transparent blur-xl" />
          <div className="absolute bottom-4 left-4 w-16 h-16 rounded-full bg-gradient-to-br from-[#00cea8]/10 to-transparent blur-xl" />
          
          <motion.div
            className="relative z-10 w-20 h-20 rounded-2xl bg-gradient-to-br from-[#915eff]/20 to-[#00cea8]/10 flex items-center justify-center"
          ...
          <h3 className="text-white text-[20px] font-bold text-center mt-4 relative z-10">
            {title}
          </h3>
          
          <div className="w-16 h-1 rounded-full bg-gradient-to-r from-[#915eff] to-[#00cea8] mt-3" />
        </div>
      </motion.div>
    </Tilt>
  );
